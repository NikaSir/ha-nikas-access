...
def main() -> None:
    ...
    require(panel_manifest["ui_version"] == "0.1.3", "panel version drift")
    require(contract["integration"]["version"] == "0.1.3", "contract version drift")
    ...
    require(contract["panel"]["header"]["title_line_2"] == "UI v0.1.3", "Header UI version drift")
