...
def main() -> None:
    ...
    require(panel_manifest["ui_version"] == "0.1.9", "panel version drift")
    require(contract["integration"]["version"] == "0.1.9", "contract version drift")
    ...
    require(standard["integration_version"] == "0.1.9", "standard integration version drift")
    require(standard["ui_version"] == "0.1.9", "standard UI version drift")
    require(standard["header_title_line_2"] == "UI v0.1.9", "standard Header UI version drift")
    ...
    require(contract["panel"]["header"]["title_line_2"] == "UI v0.1.9", "Header UI version drift")
