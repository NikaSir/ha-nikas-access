"""Register the integration-owned NikaS Access panel."""
...
PANEL_ID = "access_v1"
PANEL_TITLE = "Контроль доступа"
PANEL_SIDEBAR_TITLE = "Доступ"
PANEL_URL_PATH = "dashboard-access-v1"
PANEL_ENTRY_ROUTE = "/dashboard-access-v1/home"
PANEL_PARENT_ROUTE = "/dashboard-house-v12/home"
PANEL_ICON = "mdi:gate"
PANEL_WEB_COMPONENT = "nikas-access-panel"
PANEL_STATIC_URL = "/nikas_access_panel"
...
PANEL_BUNDLE = "nikas-access-panel.js"
...
async def async_register_panel(hass: HomeAssistant, entry_id: str) -> bool:
    ...
    if frontend.async_panel_exists(hass, PANEL_URL_PATH):
        _LOGGER.warning(
            "Route /%s already has an owner; NikaS Access preserves it unchanged",
            PANEL_URL_PATH,
        )
        return False
